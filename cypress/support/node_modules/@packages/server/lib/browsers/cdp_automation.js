...
exports.CdpAutomation = exports.normalizeResourceType = exports.isHostOnlyCookie = exports._cookieMatches = exports._domainIsWithinSuperdomain = exports.screencastOpts = void 0;
...
class CdpAutomation {
    constructor(sendDebuggerCommandFn, onFn, sendCloseCommandFn, automation, experimentalSessionAndOrigin) {
        this.sendDebuggerCommandFn = sendDebuggerCommandFn;
        this.onFn = onFn;
        this.sendCloseCommandFn = sendCloseCommandFn;
        this.automation = automation;
        this.experimentalSessionAndOrigin = experimentalSessionAndOrigin;
    ...
    static async create(sendDebuggerCommandFn, onFn, sendCloseCommandFn, automation, experimentalSessionAndOrigin) {

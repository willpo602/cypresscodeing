...
exports.open = exports.connectToExisting = exports.connectToNewSpec = exports._createDetachedInstance = void 0;
...
const windows_1 = require("../../../launcher/lib/windows");
...
async function open(browser, url, options, automation) {
    ...
    try {
        browserCriClient = await firefox_util_1.default.setup({ automation, extensions: launchOptions.extensions, url, foxdriverPort, marionettePort, remotePort, onError: options.onError, options });

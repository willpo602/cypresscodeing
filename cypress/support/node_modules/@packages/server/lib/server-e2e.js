                        ...
                        return automationRequest('get:cookies', {
                            ...
                            const concatStr = (0, network_1.concatStream)((responseBuffer) => {
                                ...
                                if (isOk && details.isHtml &&
                                    !((options.hasAlreadyVisitedUrl || options.isCrossOrigin) && !network_1.cors.urlOriginsMatch(previousRemoteState.origin, newUrl))) {
                                    // if we're not handling a local file set the remote state
                                    if (!handlingLocalFile) {
                                        this._remoteStates.set(newUrl, options);
                                    }

...
class PreRequests {
    constructor(requestTimeout = 500) {
        this.pendingPreRequests = new StackMap();
        this.pendingRequests = new StackMap();

...
const integrityTagReplacementRe = new RegExp(`(${rewriter_1.STRIPPED_INTEGRITY_TAG}|integrity)(=(?:\"|\')sha(?:256|384|512)-.*?(?:\"|\'))`, 'g');
function strip(html, { modifyObstructiveThirdPartyCode } = {
    ...
    if (modifyObstructiveThirdPartyCode) {
        rewrittenHTML = rewrittenHTML.replace(integrityTagReplacementRe, `${rewriter_1.STRIPPED_INTEGRITY_TAG}$2`);
    }
